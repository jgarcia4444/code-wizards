...
const MobileNavLinks = ({links}) => {
    ...
    return (
        <div className="relative z-10 ">
            <div onClick={() => setAnimatedClassString("right-0 opacity-100") } className="hover:cursor-pointer transition-all duration-300 hover:scale-105">
                <CiMenuFries color={iconColor} size={iconSize} />
            </div>
            <div className={`trainsition-all duration-700 absolute bg-black top-0 ${animatedClassString} z-10 p-2`}>
