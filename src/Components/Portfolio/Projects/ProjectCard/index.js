    ...
    return (
        <div className="relative rounded w-92 ">
            ...
            <a href={websiteUrl} rel="noreferrer"  target="_blank" className="">
                <div className="absolute top-0 left-0 w-full h-full bg-white bg-opacity-60 flex flex-row z-10 p-2 items-end transition-all duration-500 hover:bg-opacity-0 hover:cursor-pointer hover:scale-105 hover:text-transparent rounded">
